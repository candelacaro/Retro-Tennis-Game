...
public class Game extends JPanel {
     ...
     * Actualitza el nivell i la dificultat cada interval de 20 segons.
     */
     ...
     * Invoca els mètodes move() de totes les instàncies que formen part del joc.
     */
    protected void move() {
    ...
    /**
     * Sobreescriptura del mètode de renderitzat de Swing.
     * Dibuixa tots els elements visuals en cada frame.
     * * @param g Objecte de context gràfic.
     */
    @Override
    protected void paintComponent(Graphics g) {
    	super.paintComponent(g); // Crida al mètode de la superclasse per netejar el buffer
        g.drawImage(fondo, 0, 0, getWidth(), getHeight(), this); // Renderitzat del fons
     // Downcasting de Graphics a Graphics2D per accedir a mètodes de renderitzat avançats
        Graphics2D g2d = (Graphics2D) g;
     // Configuració de l'algorisme d'Antialiasing per a una millor qualitat visual
     ...
     * Tanca els fluxos d'àudio i mostra la notificació final a l'usuari.
     */
    public void gameOver() {
        sonido.stopFondo();  // Para la pista d'àudio principal
        sonido.playGameOver(); //Reprodueix una vegada el so
     // Diàleg modal per a la notificació de pèrdua
     ...
     * Gestiona el cicle de vida de la llista d'obstacles.
     * * @param nivellActual l'estat actual de la variable level per calcular la quantitat d'entitats.
     */
     ...
     * Configura el contenidor JFrame i executa el bucle principal del joc.
